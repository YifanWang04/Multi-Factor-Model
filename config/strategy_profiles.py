...
composite-factor, and rebalance-day entry points. Legacy config modules should
derive their exported constants from here instead of keeping separate commented
blocks of factor lists and composite sheets.
"""
